...
class Car {
  ...
  drive(distance) {
    const tankamount = distance / this.milesPerGallon;
    if (this.tank >= tankamount) {
      this.odometer += distance;
      this.tank -= tankamount;
    } else {
      const howFarCanGo = this.tank * this.milesPerGallon;
      this.tank = 0;
      this.odometer += howFarCanGo;
